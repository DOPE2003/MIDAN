      ...
      <div className="relative bg-[#080e20] pt-28 pb-20 md:pt-36 md:pb-24 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h1 className="text-[clamp(2.2rem,5vw,3.8rem)] font-extrabold text-white leading-[1.1] mb-4" style={{ letterSpacing: '-0.02em' }}>
              {t('header.title')}
            </h1>
            <p className="text-white/45 text-base leading-relaxed">{t('header.subtitle')}</p>
          </motion.div>
        </div>
      </div>
            ...
            <motion.div {...fade(0.1)}>
              <div className="bg-primary rounded-2xl p-8 text-white">
                <div className="flex items-end gap-3 mb-6">
                  ...
                  <div className="text-white/50 text-sm font-semibold tracking-widest uppercase pb-3">{tAbout('yearsLabel')}</div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-5 mb-8">
                  {[
                    ...
                    <div key={row.label}>
                      <div className="text-white/35 text-[9px] font-bold tracking-widest uppercase mb-1">{row.label}</div>
                ...
                <div className="border-t border-white/15 pt-6 flex flex-wrap gap-2">
                  {certifications.map((c) => (
                    <span key={c} className="bg-white/10 text-white/70 text-[10px] font-bold px-3 py-1 rounded-full tracking-wide">
                      {c}
                    </span>
                  ))}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
              {milestones.map((m, i) => (
                ...
                >
                  ...
                  <p className="text-white/45 text-[12px] leading-snug">{m.event}</p>
                </motion.div>
              ))}
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-primary rounded-2xl p-5 text-white text-center">
                    ...
                    <div className="text-white/50 text-xs font-semibold mt-1">{t('totalLabel')}</div>
                  </div>
                </div>
              </div>
            </motion.div>
